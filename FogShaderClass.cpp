...
{
	return InitializeShader(device, hwnd, L"./hlsl/FogVertexShader.hlsl", L"./hlsl/FogPixelShader.hlsl");
}
...
bool FogShaderClass::Render(ID3D11DeviceContext *deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix
	, int textureNum, ID3D11ShaderResourceView **textureArray, float fogStart, float fogEnd)
{
	if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, textureNum, textureArray, fogStart, fogEnd))
	{
		return false;
	}
...
HRESULT FogShaderClass::InitializeLayout(ID3D11Device *device, ID3D10Blob *vertexShaderBuffer)
{
...
bool FogShaderClass::SetShaderParameters(ID3D11DeviceContext *deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix
	, int textureNum, ID3D11ShaderResourceView **textureArray, float fogStart, float fogEnd)
{
